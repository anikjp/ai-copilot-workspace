  ...
  return (
    <div className="flex-1 min-w-0 bg-white flex items-center justify-center">
      <div className="text-center">
        ...
        <SignedOut>
          <p className="text-slate-600 text-lg mb-8">Sign in to access your AI-powered workspace</p>
        ...
        <SignedIn>
          <p className="text-slate-600 text-lg mb-8">Welcome back! Select an option from the sidebar to get started</p>
          <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
            <Link href="/stock-agent" className="p-4 bg-white rounded-lg border border-slate-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
            ...
            <Link href="/stock-agent-reference" className="p-4 bg-white rounded-lg border border-slate-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
              <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center mx-auto mb-2">
                <span className="text-green-600 text-sm">📈</span>
              </div>
              <h3 className="font-medium text-slate-900">Stock Reference</h3>
